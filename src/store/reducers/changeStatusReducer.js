...
export default createReducer(initialState, {
  [CHANGE_STATUS.CHANGE_STATUS_REQUEST]: state => {
    return {
      ...state,
      isRequesting: true,
      isSuccess: false,
  ...
  [CHANGE_STATUS.CHANGE_STATUS_SUCCESS]: (state, payload) => {
    return {
      ...state,
      isRequesting: false,
      isSuccess: true,
  ...
  [CHANGE_STATUS.CHANGE_STATUS_FAILURE]: (state, payload) => {
    return {
      ...state,
      isRequesting: false,
      isSuccess: false,
  ...
  [CHANGE_STATUS.CHANGE_STATUS_RESET]: state => {
    return {
      ...state,
      isRequesting: false,
      isSuccess: false,
