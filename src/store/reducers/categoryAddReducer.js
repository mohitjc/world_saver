...
export default createReducer(initialState, {
  [CATEGORY_ADD.CATEGORY_ADD_REQUEST]: state => {
    return {
      ...state,
      isRequesting: true,
      isSuccess: false,
  ...
  [CATEGORY_ADD.CATEGORY_ADD_SUCCESS]: (state, payload) => {
    return {
      ...state,
      isRequesting: false,
      isSuccess: true,
  ...
  [CATEGORY_ADD.CATEGORY_ADD_FAILURE]: (state, payload) => {
    return {
      ...state,
      isRequesting: false,
      isSuccess: false,
  ...
  [CATEGORY_ADD.CATEGORY_ADD_RESET]: state => {
    return {
      ...state,
      isRequesting: false,
      isSuccess: false,
